...
Besides this, there are also additional functions for calculating some specific
often used moments (besides the already previously mentioned variance):
...
The function `conv_n()` calculates the $n$-fold convolution of a distribution
