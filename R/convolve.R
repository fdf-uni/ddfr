...
#'
#' For a interpretation of the convolution, recall that given two random
#' variables \eqn{X} and \eqn{Y} with probability mass functions \eqn{p_X} and
#' \eqn{p_Y}, the sum \eqn{X + Y} has distribution \eqn{p_X \ast p_Y}.
